            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a dissable class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Gia sư ABC</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Nhập email và mật khẩu của bạn để đăng nhập</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate action="{{route('checkLoginAdmin')}}" method="post">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Quên mật khẩu? <a href="pages-register.html">Lấy lại mật khẩu</a></p>
                    </div>
                  </form>
