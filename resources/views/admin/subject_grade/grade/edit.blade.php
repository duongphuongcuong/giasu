...
@section('content')
  <main id="main" class="main">
     @include('admin.components.header_content',['name'=> 'Lớp học', 'key' => 'Chỉnh sửa'])
              ...
              <div class="card top-selling overflow-auto">
                ...
                <form action="{{route('grade.update',['id'=>$grade->id])}}" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="{{$grade->ten_khoi_lop}}" name="name"  class="form-control" required placeholder="Nhập lớp học" 
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-3">
                        <input value="{{$subject->id}}" name="subject[]" {{$subjectOfgrade->contains('id',$subject->id) ? 'checked' : ''}} type="checkbox"> {{$subject->ten_mon_hoc}}
                      </div>
                      @endforeach
                    </div>
