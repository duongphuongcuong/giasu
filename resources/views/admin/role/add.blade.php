...
@section('content')
  <main id="main" class="main">
     @include('admin.components.header_content',['name'=> 'Vai trò', 'key' => 'Thêm'])
              ...
              <div class="card top-selling overflow-auto">
                ...
                <!-- <form action="{{route('role.store')}}" method="post"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  maxlength="50" name="name"  class="form-control" required placeholder="Nhập tên vai trò" 
                    oninvalid="this.setCustomValidity('Vui lòng nhập tên nhóm / vai trò!')" oninput="this.setCustomValidity('')">
                  </div>
                  <div class="form-group" style="margin-bottom: 20px;">
                    <label class="col-form-label">Mô tả</label>
                    <input type="text" name="display_name"  class="form-control"  placeholder="Nhập mô tả vai trò" >
                  </div>
                  <div class="form-group" style="margin-bottom: 10px;">
                    <label class="col-form-label">
                      Thiết lập quyền cho vai trò (nhóm)
                    </label>
                  </div>
                  <div class="col-12">
                    <div class="row">
